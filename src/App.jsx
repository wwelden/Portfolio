...
const getTechIcon = (tech) => {
  switch(tech.toLowerCase()) {
    ...
    case 'go':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" height="78" viewBox="0 0 207 78" width="207" className="tech-icon">
    ...
    case 'unity':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 263" className="tech-icon">
          <path d="M166.9 131.2L212.8 52l22.2 79.2-22.2 79.3-46-79.3zm-22.4 13l46 79.2-80-20.5L52.6 144h91.8zM190.4 39l-45.9 79.3H52.7l57.7-58.8 80-20.5zm65.5 65.2L228 0 123.4 28l-15.5 27.2-31.4-.2L0 131.2l76.5 76.3 31.4-.2 15.5 27.2 104.5 27.9 28-104.2-15.9-27 16-27z" fill="currentColor"/>
        </svg>
      );
    case 'scala':
      return (
    ...
    case 'mysql':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 252" className="tech-icon">
...
function Projects() {
  ...
  const calculateDelay = (index) => {
    ...
    // Apply delay based on row number
    return row * 200;
  }
...
function Education() {
  ...
  const calculateDelay = (index) => {
    // Calculate which row this card is in (assuming 3 cards per row)
    const row = Math.floor(index / 3);
    // Apply the same delay to all items in the same row
    return row * 200;
  }
