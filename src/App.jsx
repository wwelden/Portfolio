...
const getTechIcon = (tech) => {
  switch(tech.toLowerCase()) {
    ...
    case 'github actions':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="tech-icon">
          <path d="M10.984 2.413a1.845 1.845 0 00-2.9 0l-3.627 4.495a1.845 1.845 0 00.366 2.592l3.198 2.37a1.845 1.845 0 002.834-.986l2.736-9.53a1.845 1.845 0 00-2.607-3.937v4.996zm.986.082V.491" fill="#2088FF"/>
          <path d="M15.42 22.284a1.845 1.845 0 01-2.9 0l-3.627-4.494a1.845 1.845 0 01.366-2.592l3.198-2.37a1.845 1.845 0 012.834.986l2.736 9.53a1.845 1.845 0 01-2.607 3.936v-4.995zm.986-.082v1.996" fill="#79B8FF"/>
          <path d="M2.413 13.284a1.845 1.845 0 010-2.9l4.495-3.627a1.845 1.845 0 012.592.366l2.37 3.198a1.845 1.845 0 01-.986 2.834l-9.53 2.736a1.845 1.845 0 01-3.937-2.607h4.996zm.082.986H.491" fill="#2088FF"/>
          <path d="M22.284 8.848a1.845 1.845 0 010 2.9l-4.494 3.627a1.845 1.845 0 01-2.592-.366l-2.37-3.198a1.845 1.845 0 01.986-2.834l9.53-2.736a1.845 1.845 0 013.936 2.607h-4.995zm-.082-.986h1.996" fill="#79B8FF"/>
        </svg>
      );
    case 'google cloud':
      return (
      ...
      <button className="theme-toggle" onClick={toggleDarkMode} aria-label="Toggle dark mode">
        {darkMode ? (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0 2c1.65 0 3 1.35 3 3s-1.35 3-3 3-3-1.35-3-3 1.35-3 3-3zm0-4V3c0-.55-.45-1-1-1s-1 .45-1 1v2c0 .55.45 1 1 1s1-.45 1-1zm0 18v-2c0-.55-.45-1-1-1s-1 .45-1 1v2c0 .55.45 1 1 1s1-.45 1-1zm8-9h2c.55 0 1-.45 1-1s-.45-1-1-1h-2c-.55 0-1 .45-1 1s.45 1 1 1zm-12.48-1.02a.996.996 0 0 0-1.41 0l-1.42 1.42c-.39.39-.39 1.02 0 1.41s1.02.39 1.41 0l1.42-1.42c.39-.39.39-1.02 0-1.41zm12.48 0c-.39-.39-1.02-.39-1.41 0l-1.42 1.42c-.39.39-.39 1.02 0 1.41s1.02.39 1.41 0l1.42-1.42c.39-.39.39-1.02 0-1.41zM7.76 7.76c.39-.39.39-1.02 0-1.41L6.34 4.93a.996.996 0 0 0-1.41 0c-.39.39-.39 1.02 0 1.41l1.42 1.42c.39.39 1.02.39 1.41 0z" />
          </svg>
        ) : (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
